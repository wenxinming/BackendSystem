...
enum API{
    ...
    //下架
    CANCELSELE_URL='/admin/product/cancelSale/',
    //获取商品详情的接口
...
//下架的请求
export const reqCancelSale = (skuId:number)=>request.get<any,any>(API.CANCELSELE_URL+skuId)
//获取商品详情的接口
export const reqSkuInfo = (skuId:number)=>request.get<any,SkuInfoData>(API.SKUINFO_URL+skuId)
//删除某一个已有的商品
export const reqRemoveSku = (skuId:number)=>request.get<any,any>(API.DELETE_URL+skuId)